.. uCore-Tutorial-Guide documentation master file, created by
...
欢迎来到 uCore-Tutorial-Guide!

指导书简介
----------------------------

该指导书为 `THU` `OS` 课程实验 `C` 版实验指导书，旨在帮助同学们快速熟悉框架并完成书面和编程任务, `配套代码 <https://github.com/learningos/ucore-Tutorial-Code>`_ 。
...
- `该文档仓库 <https://github.com/LearningOS/uCore-Tutorial-Guide>`_
